...
public class NodoAnd extends NodoOp2 {
	
	public NodoAnd(String nom, int fila, int columna) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
	}
	
	public NodoAnd(String nom, int fila, int columna, NodoExp2 exp1, NodoExp3 exp2) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
		expresion1 = exp1;
	...
	public String parseaTipos() throws Exception{
		...
		if (expresion1 != null && expresion2 != null) {
			if (expresion1.parseaTipos().equals("bool") && expresion2.parseaTipos().equals("bool")){
				return "bool";
			} else {
	...
	public String generaCodigo() throws Exception {
		...
		s += "{" + (direccion + expresion1.getLongitud() + expresion2.getLongitud()) + "}and;\n";
		return s;
	}
