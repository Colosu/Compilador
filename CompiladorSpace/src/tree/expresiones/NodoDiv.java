...
public class NodoDiv extends NodoOp2 {
	
	public NodoDiv(String nom, int fila, int columna) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
	}
	
	public NodoDiv(String nom, int fila, int columna, NodoExp2 exp1, NodoExp3 exp2) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
		expresion1 = exp1;
	...
	public String generaCodigo() throws Exception {
		...
		s += "{" + (direccion + expresion1.getLongitud() + expresion2.getLongitud()) + "}div;\n";
		return s;
	}
