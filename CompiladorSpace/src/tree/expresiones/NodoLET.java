...
public class NodoLET extends NodoOp0 {
	
	public NodoLET(String nom, int fila, int columna) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
	}
	
	public NodoLET(String nom, int fila, int columna, NodoExpresion exp1, NodoExp1 exp2) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
		expresion1 = exp1;
	...
	public String generaCodigo() throws Exception {
		...
		s += "{" + (direccion + expresion1.getLongitud() + expresion2.getLongitud()) + "}leq;\n";
		return s;
	}
