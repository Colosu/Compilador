...
public class NodoLT extends NodoOp0 {
	
	public NodoLT(String nom, int fila, int columna) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
	}
	
	public NodoLT(String nom, int fila, int columna, NodoExpresion exp1, NodoExp1 exp2) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
		expresion1 = exp1;
	...
	public String generaCodigo() throws Exception {
		...
		s += "{" + (direccion + expresion1.getLongitud() + expresion2.getLongitud()) + "}les;\n";
		return s;
	}
