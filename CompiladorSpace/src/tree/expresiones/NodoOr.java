...
public class NodoOr extends NodoOp1 {
	
	public NodoOr(String nom, int fila, int columna) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
	}
	
	public NodoOr(String nom, int fila, int columna, NodoExp1 exp1, NodoExp2 exp2) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
		expresion1 = exp1;
	...
	public String generaCodigo() throws Exception {
		...
		s += "{" + (direccion + expresion1.getLongitud() + expresion2.getLongitud()) + "}or;\n";
		return s;
	}
