...
public class NodoPow extends NodoOp3 {
	
	public NodoPow(String nom, int fila, int columna) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
	}
	
	public NodoPow(String nom, int fila, int columna, NodoExp3 exp1, NodoExp4 exp2) {
		nombre = nom;
		this.fila = fila;
		this.columna = columna;
		expresion1 = exp1;
	...
	public String parseaTipos() throws Exception{
		...
		if (expresion1 != null && expresion2 != null) {
			...
			if (expresion1.parseaTipos().equals("float") && expresion2.parseaTipos().equals("int")){
				return "float";
			} else {
	...
	public String generaCodigo() throws Exception {
		...
		s += "{" + (direccion + expresion1.getLongitud() + expresion2.getLongitud()) + "}pow;\n";
		return s;
	}

	public NodoExp3 getExpresion1() {
		return expresion1;
	}

	public NodoExp4 getExpresion2() {
		return expresion2;
	}
	...
	public void setExpresion1(NodoExp3 expresion1) {
		this.expresion1 = expresion1;
	}

	public void setExpresion2(NodoExp4 expresion2) {
	...
	private NodoExp3 expresion1;
	private NodoExp4 expresion2;
