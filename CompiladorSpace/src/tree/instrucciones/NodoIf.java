...
public class NodoIf extends NodoInstruccion {
	...
	public NodoIf(int fila, int columna, NodoExpresion exp, NodoBloque bloq) {
		this.fila = fila;
	...
	public NodoIf(int fila, int columna, NodoExpresion exp, NodoBloque bloq, NodoInstruccion sig) {
	...
	public void parseaId(Hashmap<Nodo> tabla) throws Exception{
		...
		if (expresion != null) {
			...
			throw new Exception("El If que está en la linea " + fila + " y columna " + columna +" no tiene expresión.");
		}
		
		if (bloque != null) {
			bloque.parseaId(tabla);
		} else {
			throw new Exception("El If que está en la linea " + fila + " y columna " + columna +" no tiene bloque de instrucciones.");
		}
	...
	public String parseaTipos() throws Exception {
		...
		if (expresion != null) {
			if (expresion.parseaTipos().equals("bool")) {
				...
				throw new Exception("Error de tipos en la expresión del If que está en la linea " + fila + " y columna " + columna +".");
			}
		} else {
			throw new Exception("El If que está en la linea " + fila + " y columna " + columna +" no tiene expresión.");
		}
	...
	public String generaCodigo() throws Exception {
		...
		s += "{" + (direccion + expresion.getLongitud()) + "}fjp " + (bloque.getDireccion() + bloque.getLongitud()) + ";\n";
